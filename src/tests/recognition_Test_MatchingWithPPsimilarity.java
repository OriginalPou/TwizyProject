...
class recognition_Test_MatchingWithPPsimilarity {
    ...
    Mat objetrond = null;
		  ...
		  if (objetrond!= null) 
			  assertEquals(Utilities.Match(objetrond,panels,Utilities.Matching_With_PPSimilarity),3);	  
		  }
    ...
    Mat objetrond = null;
		  ...
		  objetrond=Utilities.DetectForm(testFile,contour);
		  if (objetrond!= null) 
			  assertEquals(Utilities.Match(objetrond,panels,Utilities.Matching_With_PPSimilarity),0);	  
		  }
    ...
    Mat objetrond = null;
		  ...
		  objetrond=Utilities.DetectForm(testFile,contour);
		  if (objetrond!= null) 
			  assertEquals(Utilities.Match(objetrond,panels,Utilities.Matching_With_PPSimilarity),1);	  
		  }
    ...
    Mat objetrond = null;
		  ...
		  objetrond=Utilities.DetectForm(testFile,contour);
		  if (objetrond!= null) 
			  assertEquals(Utilities.Match(objetrond,panels,Utilities.Matching_With_PPSimilarity),2);	  
		  }
    ...
    Mat objetrond = null;
		  ...
		  objetrond=Utilities.DetectForm(testFile,contour);
		  if (objetrond!= null) 
			  assertEquals(Utilities.Match(objetrond,panels,Utilities.Matching_With_PPSimilarity),4);	  
		  }
    ...
    Mat objetrond = null;
		  ...
		  objetrond=Utilities.DetectForm(testFile,contour);
		  if (objetrond!= null) {
			  assertEquals(Utilities.Match(objetrond,panels,Utilities.Matching_With_PPSimilarity),ref[i]);
			  i++;
		  }
		  }
